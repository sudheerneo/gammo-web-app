            ...
            <div className="col-lg-8" bis_skin_checked="1">
              ...
              >
                ...
                <p
                  ...
                  id="test"
                >
                  Unlock your earning potential with your skills! Victory means
                  instant payment, so let your strategy and average skills take
                  you to the top. Level up your productivity and become a true
                  gamer! Join us today and let's conquer the esports world
                  together!
                </p>
                <a
            ...
            <div className="col-lg-8" bis_skin_checked="1">
              <div className="about-content" bis_skin_checked="1">
                <div className="section-header has--bg" bis_skin_checked="1">
                  ...
                  <h2 className="section-title">Win big with your skills</h2>
                </div>
                <p>
                  Our main focus is to provide the best opportunity for players
                  to showcase their mind-blowing skills and earn rewards. We
                  believe in encouraging players of their favorite games to
                  exhibit high-quality skills in every possible way. We ensure
                  that our tournaments and events are engaging, with unique
                  in-game challenges that are captivating, stunning, and
                  precise. We never compromise on quality and do whatever it
                  takes to offer a memorable gameplay experience, with everyday
                  prize money that can help make your dreams a reality
                </p>
                <a
                      ...
                      <div className="post-card__content">
                        ...
                        <h3 className="post-title">
                          <a href="blog-details.html">
                            Tip - in every match earn free pass with reaching
                            top 10 on every match
                          </a>
                        </h3>
                  ...
                  <div className="carousel-item">
                    <div className="post-card">
                      ...
                      <i className="las la-file-alt"></i>
                        ...
                        <h3 className="post-title">
                          <a href="blog-details.html">
                            It's very easy to earn if you play smart and stay in
                            the game like a pro until the last zone.
                          </a>
                        </h3>
                        <div className="post-author mt-3">
                          <div className="post-author__thumb">
