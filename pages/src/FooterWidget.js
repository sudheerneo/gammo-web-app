  ...
  return (
    <div>
            ...
            <div className="account-area">
              <form className="account-form">
                ...
                <div className="form-group mt-3">
                  <p>
                    <a href="#">
                      Currently we don't support horizontal mode, pls rotate
                      your device to vertical mode. Thank you
                    </a>
                  </p>
                  <p style={{ textAlign: "center" }}>
                    {" "}
                    {"Screen Resolution : " + cliheight + " x " + cliwidth}{" "}
                  </p>
                  <p style={{ textAlign: "center" }}>
                    {" "}
      ...
      <div
        ...
        data-background="assets/images/footer.png" style={{backgroundImage: 'url("assets/images/footer.png")'}}
      >
          ...
          <div className="row">
            <div className="col-lg-12">
              <div className="subscribe-area">
                <div className="obj">
                  <img src="assets/images/subscribe.png" alt="image" />
                </div>
                <div className="subscribe-content">
                  ...
                  <p>
                    You will get one free entry game pass, to win Rs 2,000 match
                    for each and every verified invitaion for new logins,
                    GP(gamepass) purchases. There is no limit but only for the
                    successfull partcipation from your request will get pass
                    surely credited to your account
                  </p>
                  <p></p>
              ...
              <div className="row footer-top mb-none-50">
                <div className="mb-50" style={{ paddingLeft: "20px " }}>
                  <div className="footer-widget">
                    ...
                    <ul className="short-links" style={{ opacity: "0.9" }}>
                      <li>
                        <a href="#0">About Us</a>
                      </li>
                      <li>
                ...
                <div className="mb-50" style={{ paddingLeft: "30px " }}>
                  <div className="footer-widget">
                    <h3 className="footer-widget__title">MY ACCOUNT</h3>
                    <ul className="short-links" style={{ opacity: "0.9" }}>
                      <li>
                        <a href="#0">Manage My Account</a>
                      </li>
                      <li>
                        <a href="#0">Account Varification</a>
                      </li>
                      <li>
                        <a href="#0">Withdwaw process</a>
                      </li>
                      <li>
                        <a href="#0">Safety & Security</a>
                      </li>
                    </ul>
                  </div>
                  {/* footer-widget end */}
                ...
                <div className="mb-50" style={{ paddingLeft: "20px " }}>
                  <div className="footer-widget">
                    <h3 className="footer-widget__title">HELP CENTER</h3>
                    <ul className="short-links" style={{ opacity: "0.9" }}>
                      <li>
                ...
                <div className="mb-50" style={{ paddingLeft: "30px " }}>
                  <div className="footer-widget">
                    ...
                    <ul className="short-links" style={{ opacity: "0.9" }}>
                      ...
                      <li>
                        <a href="#0">Become Affiliate</a>
                      </li>
                      <li>
                        <a href="#0">Complaints Policy</a>
                      </li>
                    </ul>
                  </div>
                  {/* footer-widget end */}
