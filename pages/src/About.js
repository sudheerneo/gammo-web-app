...
<section className="about section-image" id="about" data-sorder="hestia_about" style={{backgroundImage: "url('http://localhost/wp-content/uploads/2017/01/FScopy.jpg')"}}>
										...
										<div className="so-widget-sow-editor so-widget-sow-editor-base">
											<div className="siteorigin-widget-tinymce textwidget">
												...
												<p style={{textAlign: "center"}}>
													<a className="ow-button-hover" href="https://googlewebdevelopers.com/jlum.org/t"></a></p>
												<p>
